        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 text-center">
              ...
              <div className="text-5xl font-bold text-[#174a21] my-4">$3,997</div>
              <div className="bg-[#996516]/10 text-[#996516] px-4 py-2 rounded-lg font-semibold text-lg mb-6">
                Save <span className="text-2xl">$350</span> when you pay in full!
              </div>
              <a
                href="https://api.taxnitro.com/payment-link/675086a2a025e805aa89b340"
                target="_blank"
            ...
            <div className="bg-white rounded-2xl p-8 text-center">
              ...
              <div className="text-3xl font-bold text-[#174a21] my-4">
                <div>$1,597 Initial</div>
                <div className="text-xl text-[#174a21]/80">+ 11 × $250</div>
              </div>
              <p className="text-[#174a21]/80 mb-6">Flexible monthly payments</p>
              <a
                href="https://api.taxnitro.com/payment-link/677c8ebefdd53c8f5321561f"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-[#996516] text-white px-6 py-3 rounded-lg hover:bg-[#996516]/90 transition duration-300 text-lg font-semibold"
              >
