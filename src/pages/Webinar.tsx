      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="space-y-6 text-lg md:text-xl font-medium text-gray-700 leading-relaxed">
            ...
            <p>And if you're earning $150K+ (W-2) or $250K+ (business owner), even one overlooked move can cost you five figures.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg md:text-xl font-bold text-gra
